...
protocol ShowTextFieldDelegate: class {
    func isValidPassword(_ password: String) -> Bool
}

public class ShowTextField: UITextField {
    weak var passwordDelegate: ShowTextFieldDelegate?
...
extension ShowTextField: PasswordToggleVisibilityDelegate {
