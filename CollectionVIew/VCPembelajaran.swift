...
class VCPembelajaran: UIViewController {
    enum Mode {
        case view
        case select
    }
...
//
//extension VCPembelajaran: UICollectionViewDelegate, UICollectionViewDataSource {
//
...
//}
//
//extension VCPembelajaran: CustomLayoutDelegate {
